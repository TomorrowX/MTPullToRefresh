...
import com.mingtian.mtpulltorefresh.internal.EmptyViewMethodAccessor;
import com.mingtian.mtpulltorefresh.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	protected void handleStyledAttributes(TypedArray a) {
		...
		mShowIndicator = a.getBoolean(com.handmark.pulltorefresh.library.R.styleable.PullToRefresh_ptrShowIndicator, !isPullToRefreshOverScrollEnabled());
	}
	...
	private void addIndicatorViews() {
		...
		if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
			...
			params.rightMargin = getResources().getDimensionPixelSize(com.handmark.pulltorefresh.library.R.dimen.indicator_right_padding);
